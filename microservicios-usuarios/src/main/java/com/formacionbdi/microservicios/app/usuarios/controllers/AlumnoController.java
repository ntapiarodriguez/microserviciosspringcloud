...
public class AlumnoController extends CommonController<Alumno, AlumnoService> {
	...
	public ResponseEntity<?> editarConFoto(@Valid Alumno alumno, @PathVariable Long id, BindingResult result, @RequestParam MultipartFile archivo) throws IOException {
